import { VStack, Stack, Heading, Text, Center, Button } from '@chakra-ui/react'
...
const Videos = () => {
  ...
  return (
    <Stack direction={['column','row']} h={'100vh'} padding={'1'}>
        <VStack w={'full'}>
            <video 
            controls
            controlsList='nodownload'
            src={videosrc} style={{width:"100%",}}></video>
            <VStack w={'full'} alignItems={'flex-start'} p={'2'} overflowY={'auto'}>
                <Heading>Sample Video 1</Heading>
                <Text>
                    This a sample video and this is the description This a sample video and this is the description This a sample video and this is the description This a sample video and this is the description This a sample video and this is the description This a sample video and this is the description This a sample video and this is the description 
                </Text>
            </VStack>
        </VStack>
